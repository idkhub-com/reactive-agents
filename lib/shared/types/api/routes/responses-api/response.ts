 ...
 */
export const StructuredOutputAnnotation = z.union([
  FileCitationAnnotation,
  URLCitationAnnotation,
  FilePathAnnotation,
]);

export type StructuredOutputAnnotation = z.infer<
  typeof StructuredOutputAnnotation
>;
 ...
 */
export const StructuredOutputContent = z.object({
  /**
   * Array of annotations for the text output (file citations, URL citations, file paths, etc.)
   */
  annotations: z.array(StructuredOutputAnnotation),
  /**
...
export type StructuredOutputContent = z.infer<typeof StructuredOutputContent>;

/**
 * A structured output item from the model containing content and metadata.
 */
export const StructuredOutput = z.object({
  /**
   * Array of content items generated by the model
   */
  content: z.array(StructuredOutputContent),
  /**
 ...
 */
export const StructuredOutputWithRefusal = z.object({
  /**
   * Array of content items generated by the model (present when request is fulfilled)
   */
  content: z.array(StructuredOutputContent).optional(),
  /**
   * Unique identifier for this output item
   */
  id: z.string(),
...
export type StructuredOutputWithRefusal = z.infer<
  typeof StructuredOutputWithRefusal
>;

/**
 * Structured reasoning output from o1 models that includes reasoning traces
 */
export const StructuredReasoningOutput = z.object({
  /**
...
export type StructuredReasoningOutput = z.infer<
  typeof StructuredReasoningOutput
>;
