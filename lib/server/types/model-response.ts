...
// biome-ignore lint/style/noNamespace: File will be removed in the future.
...
export interface ResponseComputerToolCall {
   ...
   */
  pending_safety_checks: ResponseComputerToolCall.PendingSafetyCheck[];
...
export interface ResponseFileSearchToolCall {
   ...
   */
  results?: ResponseFileSearchToolCall.Result[] | null;
}
...
export namespace ResponseInputItem {
  ...
  export interface ComputerCallOutput {
     ...
     * developer.
     */
    acknowledged_safety_checks?: ComputerCallOutput.AcknowledgedSafetyCheck[];
...
// biome-ignore lint/style/noNamespace: Will be removed in the future.
