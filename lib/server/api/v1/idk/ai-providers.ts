...
export const aiProvidersRouter = new Hono<AppEnv>()
  ...
  // GET /v1/idk/ai-providers/schemas - Get all AI provider custom fields schemas
  .get('/schemas', (c) => {
  ...
  // GET /v1/idk/ai-providers/schemas/:provider - Get specific provider schema
  ...
  // GET /v1/idk/ai-providers - List all AI providers
  ...
  // POST /v1/idk/ai-providers - Create new AI provider
  ...
  // PATCH /v1/idk/ai-providers/:id - Update AI provider
  .patch(
    '/:id',
  ...
  // DELETE /v1/idk/ai-providers/:id - Delete AI provider
  .delete(
    '/:id',
    zValidator('param', z.object({ id: z.string() })),
    async (c) => {
