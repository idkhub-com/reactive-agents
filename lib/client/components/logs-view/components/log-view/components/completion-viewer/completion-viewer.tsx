...
import { ChatCompletionsAPIViewer } from '@client/components/logs-view/components/log-view/components/completion-viewer/chat-completions-api';
import { CompletionsAPIViewer } from '@client/components/logs-view/components/log-view/components/completion-viewer/completions-api';
import { ImageGenerationViewer } from '@client/components/logs-view/components/log-view/components/completion-viewer/images-api';
