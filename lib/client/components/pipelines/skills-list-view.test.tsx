...
let mockPathname = '/pipelines/Test%20Agent';
...
const createDatasetsCtx = (
  ...
  ({
    ...
    setDataPointQueryParams: vi.fn(),
    refetchDataPoints: vi.fn(),
    addDataPoints: vi.fn(async () => []),
    deleteDataPoints: vi.fn(async () => {
      /* noop */
    }),
    isCreating: false,
    isUpdating: false,
    ...
    isDeletingDataPoints: false,
    addDataPointsError: null,
    deleteDataPointsError: null,
    hasNextPage: false,
    isFetchingNextPage: false,
    fetchNextPage: vi.fn(),
    getDatasetById: vi.fn(() => undefined),
    refreshDatasets: vi.fn(),
    loadDataPoints: vi.fn(),
    ...overrides,
...
const createEvaluationRunsCtx = (
  ...
  ({
    ...
    deleteError: null,
    dataPointOutputs: [],
    dataPointOutputsLoading: false,
    dataPointOutputsError: null,
    dataPointOutputQueryParams: {},
    setDataPointOutputQueryParams: vi.fn(),
    refetchDataPointOutputs: vi.fn(),
    hasNextPage: false,
    isFetchingNextPage: false,
    fetchNextPage: vi.fn(),
    getEvaluationRunById: vi.fn(() => undefined),
    refreshEvaluationRuns: vi.fn(),
    loadDataPointOutputs: vi.fn(),
    ...overrides,
...
describe('SkillsListView', () => {
  beforeEach(() => {
    ...
    mockPathname = '/pipelines/Test%20Agent';
  });
