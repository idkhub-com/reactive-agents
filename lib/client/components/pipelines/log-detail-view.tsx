...
import { CompletionViewer } from '@client/components/logs-view/components/log-view/components/completion-viewer';
import { LogMap } from '@client/components/logs-view/components/log-view/components/log-map';
import { MessagesView } from '@client/components/logs-view/components/log-view/components/messages-view';
...
export function LogDetailView(): ReactElement {
  ...
  const handleBack = () => {
    if (navigationState.selectedAgent && navigationState.selectedSkill) {
      const fallbackUrl = `/pipelines/${encodeURIComponent(navigationState.selectedAgent.name)}/${encodeURIComponent(navigationState.selectedSkill.name)}/logs`;
