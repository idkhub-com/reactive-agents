...
**Main Goal:** Create API request translations between the super-agents API and the Google AI provider API, and translate responses back from the Google AI provider API to the super-agents API format.
