# Super Agents Example: Multi-Agent Business Workflows
...
First, start the Super Agents server in one terminal:
```bash
...
**Connection Issues:**
- Ensure Super Agents server is running on `http://localhost:3000`
