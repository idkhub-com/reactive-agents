...
describe('CreateSkillView', () => {
  ...
  it('shows agent-specific header when selectedAgent exists', async () => {
    ...
    setMockParams({ agentName: 'Test Agent 1' });
    setMockPathname('/agents/Test%20Agent%201/create-skill');
  ...
  it('navigates back when cancel button is clicked', () => {
    ...
    // Check that navigate was called with the agents path
  ...
  it('navigates to setup page after successful skill creation', async () => {
    ...
    mockCreateSkill.mockImplementation(() => {
      ...
      routerMockState.navigate({
        to: '/agents/Test%20Agent%201/test-skill/setup',
        replace: true,
      });
