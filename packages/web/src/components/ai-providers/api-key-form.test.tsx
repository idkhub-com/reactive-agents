...
import { APIKeyForm } from '@web/components/ai-providers/api-key-form';
import { useAIProviders } from '@web/providers/ai-providers';
import type React from 'react';
import { beforeEach, describe, expect, it, vi } from 'vitest';
import { resetRouterMocks, routerMockState } from '@/vitest.setup';
...
// Mock UI components
vi.mock('@web/components/ui/page-header', () => ({
  PageHeader: ({
    title,
    description,
    onBack,
...
describe('APIKeyForm', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    resetRouterMocks();
    // The component uses window.history.back() directly
  ...
  describe('Navigation', () => {
    ...
    it('should call window.history.back when cancel button is clicked', async () => {
      render(<APIKeyForm mode="create" />);
