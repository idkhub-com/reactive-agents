...
export function constructRequest(
  ...
  const originalContentType = saRequestData.requestHeaders['content-type'];
  ...
  const updatedHeaders: Record<string, string> = {
    ...
    ...baseHeaders,
    ...forwardedHeaders,
    ...(saRequestData.functionName === 'proxy' && proxyHeaders),
  };
  ...
  const isGetMethod = saRequestData.method === HttpMethod.GET;
