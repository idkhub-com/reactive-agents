import { sseEventsMiddleware } from '@api/middlewares/sse-events';
...
export const superAgentsRouter = new Hono<AppEnv>()
  // Apply SSE events middleware to all super-agents routes
