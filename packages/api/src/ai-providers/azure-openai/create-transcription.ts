...
export const azureOpenAICreateTranscriptionResponseTransform: ResponseTransformFunction =
  (aiProviderResponseBody, aiProviderResponseStatus) => {
    ...
    return aiProviderResponseBody as unknown as CreateTranscriptionResponseBody;
  };
