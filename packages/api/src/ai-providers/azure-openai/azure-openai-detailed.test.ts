...
import { azureOpenAIAPIConfig } from '@api/ai-providers/azure-openai/api';
import {
  azureOpenAIChatCompleteConfig,
  azureOpenAIChatCompleteResponseTransform,
} from '@api/ai-providers/azure-openai/chat-complete';
import { azureOpenAICompleteConfig } from '@api/ai-providers/azure-openai/complete';
import {
  azureOpenAICreateSpeechConfig,
  azureOpenAICreateSpeechResponseTransform,
} from '@api/ai-providers/azure-openai/create-speech';
import {
  azureOpenAIEmbedConfig,
  azureOpenAIEmbedResponseTransform,
} from '@api/ai-providers/azure-openai/embed';
import {
  azureOpenAIImageGenerateConfig,
  azureOpenAIImageGenerateResponseTransform,
} from '@api/ai-providers/azure-openai/image-generate';
import {
  azureOpenAIFinetuneResponseTransform,
  getAccessTokenFromEntraId,
  getAzureManagedIdentityToken,
} from '@api/ai-providers/azure-openai/utils';
import {
  FunctionName,
