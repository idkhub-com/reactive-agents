import mistralAIAPIConfig from '@api/ai-providers/mistral-ai/api';
import {
  mistralAIChatCompleteConfig,
  mistralAIChatCompleteResponseTransform,
  mistralAIChatCompleteStreamChunkTransform,
} from '@api/ai-providers/mistral-ai/chat-complete';
import {
  mistralAIEmbedConfig,
  mistralAIEmbedResponseTransform,
} from '@api/ai-providers/mistral-ai/embed';
import { mistralAIConfig } from '@api/ai-providers/mistral-ai/index';
import type {
  MistralAIChatCompleteResponse,
  MistralAIEmbedResponse,
  MistralAIStreamChunk,
} from '@api/ai-providers/mistral-ai/types';
import { mistralAIErrorResponseTransform } from '@api/ai-providers/mistral-ai/utils';
  ...
  describe('API Configuration', () => {
    it('should return Mistral AI API as default base URL', () => {
      const baseURL = mistralAIAPIConfig.getBaseURL({
        saTarget: { provider: AIProvider.MISTRAL_AI },
