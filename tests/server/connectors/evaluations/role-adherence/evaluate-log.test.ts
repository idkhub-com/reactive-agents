          ...
          content: [
            {
              ...
              text: JSON.stringify({
                score: 1.0,
                reasoning:
                  'The assistant maintains a professional customer service tone and approach',
              }),
            },
          ],
        },
          ...
          choices: [
            {
              ...
              message: {
                role: 'assistant',
                content: 'Whatever dude, not my problem.',
              },
              finish_reason: 'stop',
            },
          ],
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                score: 0.0,
                reasoning:
                  'The assistant fails to maintain professional customer service demeanor',
              }),
            },
          ],
        },
